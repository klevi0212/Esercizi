...
// You will use this interface to describe the shape of the objects in the arrays below. Change the types for the properties
// in this interface so they are correct.
